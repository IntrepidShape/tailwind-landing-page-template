      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Our Proccess</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">You reach out to us, with a brief summary of the problem you are facing and what you envision being built.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">We will orginise a call, to gain a complete understanding of the requirements. This may be done in multiple sessions. </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Project Feasibility & Scope</h4>
              <p className="text-gray-600 text-center">Research is done to analyise feasibility. We try to find a balance between client vision, budget and timeline. </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">To aid in understanding, validate user requirements and to explore new ideas and concepts.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">A cycle of writing the software to specification, testing it and iterating upon it begins.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Launch</h4>
              <p className="text-gray-600 text-center">The software now meets all specifications, passes all tests and is ready for users.</p>
            </div>
